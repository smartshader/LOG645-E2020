...
## to execute, run the script by doing ./prepPar.sh $1 ##
## where $1 is your student ID in caps ##
## EXAMPLE : ./prepPar.sh AJ12345 ##
...
echo ''
scp -p -r $_mydir'/par/src' $_mydir'/par/Makefile' $_mydir'/par/run.sh' $_studentID@$_serverID:
