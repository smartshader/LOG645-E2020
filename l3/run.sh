...
echo ""
echo "<<<"
mpirun -np 2 ./lab3 7 10 300 0.01 1 9
echo ">>>"

echo ""
echo "<<<"
mpirun -np 2 ./lab3 5 9 300 0.01 1 9
echo ">>>"
...
echo ""
echo "<<<"
mpirun -np 2 ./lab3 10 10 300 0.01 1 9
echo ">>>"

echo ""
echo "<<<"
mpirun -np 2 ./lab3 12 12 300 0.01 1 9
echo ">>>"

echo ""
echo "<<<"
mpirun -np 2 ./lab3 11 11 300 0.01 1 9
echo ">>>"

echo ""
echo "<<<"
mpirun -np 2 ./lab3 4 11 300 0.01 1 9
echo ">>>"
